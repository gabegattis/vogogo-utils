...
Vogogo.prototype.pay = function(params, callback) {
  ...
  var url = '/pay';
  self._post(url, params, {customerAccessToken: params.customerAccessToken}, function(err, res, body) {
    if (err) {
      return callback(err);
    }
...
Vogogo.prototype.getTransaction = function(params, callback) {
  ...
  self._get(url, {}, {customerAccessToken: params.customerAccessToken}, function(err, res, body) {
    if (err) {
      return callback(err);
    }
...
Vogogo.prototype.listTransactions = function(params, callback) {
  ...
  self._get(url, params, {customerAccessToken: params.customerAccessToken}, function(err, res, body) {
    if (err) {
      return callback(err);
    }
